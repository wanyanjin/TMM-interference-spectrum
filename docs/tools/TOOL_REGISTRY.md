...
| `reflectance_qc` | planned | Phase 09 | planned | planned | planned | planned | planned | This phase establishes architecture and skeleton only, not the GUI business tool. |
