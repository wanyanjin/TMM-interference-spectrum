...
| `reflectance_qc` | experimental | Phase 09B | `src/cli/reflectance_qc.py` | planned | `src/workflows/reflectance_qc_workflow.py` | `src/core/reflectance_qc.py` | `docs/cli/reflectance_qc.md`, `docs/tools/reflectance_qc.md` | Minimal CLI + workflow loop exists; GUI and richer adapters remain future work. |
