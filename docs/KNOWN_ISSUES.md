...
## Phase 10A Known Limits
- Materials split from Phase05c aligned table remain experimental and are not final truth nk sources.
- Registry validation is lightweight and should migrate to strict schema validation later.
