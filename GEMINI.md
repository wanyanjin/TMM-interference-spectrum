...
项目根目录只允许放置稳定入口文件和项目级配置文件，例如 `GEMINI.md`、`README.md`、`CURRENT_TASK.md`、`CHANGELOG_DIGEST.md`、`pyproject.toml`、`uv.lock`、`.gitignore`、`src/`、`tests/`、`docs/`、`data/`、`results/`、`resources/`、`configs/`、`scripts/`、`test_data/`、`tools/`。
